...
define('DB_HOST',     'localhost');   // Servidor de base de datos (XAMPP local)
define('DB_USER',     'root');        // Usuario de MySQL (XAMPP usa 'root' por defecto)
define('DB_PASSWORD', '');            // Contraseña de MySQL (XAMPP vacía por defecto)
define('DB_NAME',     'puntos_red'); // Nombre de la base de datos
define('DB_CHARSET',  'utf8mb4');    // Charset para soportar emojis y caracteres especiales
